#include <stdio.h>
#include <stdlib.h>
//node er duita part -> data and next node er address; 
struct node {
  int data;
  struct node *next;//ekta node porer "node" ke point kore tai 
};

struct node *start = NULL;//start = head which is pointing to null at first
